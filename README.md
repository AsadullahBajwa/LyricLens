...
The workspace now includes a built-in demo lyric, optional context notes, section-template helpers, lyric cleanup, rich lyric stats, autosaved drafts, searchable pinned interpretation history, selectable interpretation lenses, searchable result sections, collapsible output, and `.txt`, `.md`, or `.json` exports.
