...
The workspace now includes a built-in demo lyric, optional context notes, analysis presets, output language selection, section-template helpers, lyric cleanup, local lyric quality hints, rich lyric stats, private mode, autosaved drafts, searchable pinned interpretation history with backup/restore, selectable interpretation lenses, searchable result sections, per-section copy, collapsible output, and `.txt`, `.md`, or `.json` exports.
