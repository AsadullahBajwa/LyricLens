...
The workspace now includes a built-in demo lyric, lyric cleanup, word and line stats, autosaved drafts, recent interpretation history, selectable interpretation lenses, searchable result sections, collapsible output, and `.txt`, `.md`, or `.json` exports.
